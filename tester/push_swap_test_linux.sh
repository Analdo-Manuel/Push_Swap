...
ARG=$(seq 500000000 500000499 | shuf | tr '\n' ' ')
N=$(./push_swap $ARG | wc -l)
if [ $N -lt 5500 ]; then
	printf "${GREEN}[OK][5/5]${DEF_COLOR}";
elif [ $N -gt 5500 ] && [ $N -lt 7000 ]; then
